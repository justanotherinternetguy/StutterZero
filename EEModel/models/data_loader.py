...
class SpectrogramDataset(Dataset, SpectrogramParser):
    ...
    def __getitem__(self, index):
        ...
        file_name = os.path.basename(audio_path)  # You can choose to return the audio path or just the file name
        
        return spect, transcript, tts_spect, file_name  # Add file_name to the return
...
def _collate_fn(batch):
    ...
    return seqs, targets, tts_seqs, seq_lengths, target_lengths, tts_seq_lengths, file_names
